import { recentActivity as mockRecentActivity } from "@/lib/data";
import Avatar from "./Avatar";
import Link from "next/link";

export default function RecentActivityCard({ recentActivity = mockRecentActivity }: { recentActivity?: any[] }) {
  return (
    <div className="w-full h-full flex-1 flex flex-col justify-between rounded-xl border border-gray-200/80 bg-white p-3 shadow-2xs overflow-hidden min-h-0">
      ...
      <ul className="flex-1 min-h-0 space-y-2 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] pr-0.5 flex flex-col justify-around">
