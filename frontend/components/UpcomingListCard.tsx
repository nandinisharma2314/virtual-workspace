import { Video, Megaphone, Palette, Server } from "lucide-react";
import { upcomingList as mockUpcomingList } from "@/lib/data";
...
export default function UpcomingListCard({ upcomingList = mockUpcomingList }: { upcomingList?: any[] }) {
  return (
